    ...
    return (
        <div className="relative inline-block text-left" ref={containerRef}>
            <button
                ...
                className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none"
                aria-haspopup="menu"
                aria-expanded={open}
            >
                TV Show
                <svg
                    className="ml-2 -mr-0.5 h-4 w-4 text-gray-500"
